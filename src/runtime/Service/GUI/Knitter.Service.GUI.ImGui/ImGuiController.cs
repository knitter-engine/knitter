...
//#endif
namespace Knitter.Service.GUI.ImGUI;

public class ImGuiController : IDisposable
{
private GL _gl;
private IWindow _window;
/*private IInputContext _input;*///TODO
private bool _frameBegun;
private readonly List<char> _pressedChars = new List<char>();
    //private IKeyboard _keyboard;//TODO
...
private ImGui.Texture _fontTexture;
...
/// </summary>
public ImGuiController(GL gl, IWindow view/*, TODO:IInputContext input*/) : this(gl, view, /*input,*/ null, null)
{
}
...
private void Init(GL gl, IWindow view/*, IInputContext input*/)
{
    ...
    _window = view;
    /*_input = input;*/
    view.GetWindowSize(out _windowWidth, out _windowHeight);
...
private void SetPerFrameImGuiData(float deltaSeconds)
{
    ...
    {
            //TODO: io.DisplayFramebufferScale = new Vector2(_window.FramebufferSize.X / _windowWidth, _window.FramebufferSize.Y / _windowHeight);
            // FramebufferSize 和WindowSize有什么区别?FramebufferSize是有glViewPort决定的吗？
...
private unsafe void RecreateFontDeviceTexture()
{
    ...
    _fontTexture = new ImGui.Texture(_gl, width, height, pixels);
    _fontTexture.Bind();
